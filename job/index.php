...
<body>
    <center>
        <div id="header1">
            ...
            <div id="login">
                <a href="registration.php" class="login-btn">Login</a>
            </div>
        </div>
        ...
        <div id="header2"> 
            <div id="header2UL">
                <ul>
                    ...
                    <li><a href="email/index.html">Hiring Agent</a></li>
...
<br>
<button class="resume-btn" onclick="window.location.href='#'"><strong>Create Your Resume</strong</button>
<h6>Login for Access our Tool</h6>
    </div>
    <footer>
        <div id="footer">
            <div class="content">
